/**
 * agentic-patterns — curriculum, quiz banks and instruments.
 *
...
(function () {
  ...
  /* ---------- GO ---------- */
  Agentcraft.init({
    storageKey: 'agentcraft_ap_full_v1',
    sections: SECTIONS,
    quizzes: QUIZZES,
    instruments: {
      loop: buildLoop,
    ...
    verdict: function (pctv) {
      return pv>=83?"<b>Excellent.</b> You've got the agentic-patterns toolkit down.":pv>=50?"<b>Solid.</b> Revisit the lessons flagged in the answers you missed.":"<b>Worth another pass.</b> Re-run Sections 1–2 (foundations + ReAct), then retry.";
    },
  });
})();
