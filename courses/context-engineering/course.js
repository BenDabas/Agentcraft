/**
 * context-engineering — curriculum, quiz banks and instruments.
 *
...
(function () {
  ...
  /* ---------- GO ---------- */
  Agentcraft.init({
    storageKey: 'agentcraft_ce_full_v1',
    sections: SECTIONS,
    quizzes: QUIZZES,
    instruments: {
      sim: buildSim,
    ...
    verdict: function (pctv) {
      return pctv>=83?"<b>Excellent.</b> You've got context engineering cold. On to the companion course.":pctv>=50?"<b>Solid.</b> Revisit the lessons flagged in the answers you missed, then you're set.":"<b>Worth another pass.</b> Re-run Sections 1 and 2 — the foundations and the four operations — then retry.";
    },
  });
})();
